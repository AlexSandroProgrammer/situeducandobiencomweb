...
<body class="bg-white">
    ...
    <nav class="navbar " style="background:#0b56a0 ">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="btn btn-light font-weight-bold text-dark " href="./consulta/paginaConsulta.php"> <i
        ...
        <form class="form-inline my-2 my-lg-0" label="Floated Right" name="form">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="btn btn-light font-weight-bold text-dark border-white"
                        href="https://senaempresalagranja.blogspot.com/"><i class="icon-spinner11"></i> Volver al Blog
                    </a>
                </li>
            </ul>
        </form>
                    ...
                    <form>
                        ...
                        <div class="input-group">
                            <div class="input-group-append">
                                <input type="text" name="usuario" id="usuario" class="form-control"
                                    placeholder="@misena.edu.co" required>
                        ...
                        <div class="input-group">
                            <div class="input-group-append">
                                ...
                                <button type="button" class="btn btn-primary" onclick="mostrarPassword()"> <i
                                        class="icon-eye-blocked icon"></i> </button>
                            </div>
                        </div>
                        <br>
                        <div class="form-group mx-sm-3 mb-2">
                            <button type="button" onclick="loguear()"
                                class="btn btn-block bg-warning form-control font-weight-bold" id="logeo"><span
                                    class="icon-enter text-light"></span> Ingresar</button>
                        </div>
