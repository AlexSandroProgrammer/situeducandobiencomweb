...
<h1 align="center" style="font-weight: bold;"><?php if(isset($busqueda)){ echo "Busqueda";}else{echo "Lista";} ?> de Fichas</h1>
  <table  width="500" class="" style=" margin-top: 60px;" align="center">
            ...
            <th align='center'style="border: black; width: 120px;height: 50px;"> <?php if(isset($E)){ echo utf8_decode("N°");} else{ echo "N°";}?>Ficha</th>
            <th align='center'style="border: black; width: 140px;height: 60px;"><?php if(isset($E)){echo utf8_decode("Nombre Programa de Formación");}else{echo "Nombre Programa de Formación"; } ?></th>
            ...
            <th align='center'style="border: black; width: 120px;height: 50px;">Inicio <?php if(isset($E)){echo utf8_decode("Formación");}else{ echo "Formación";} ?></th>
  ...
  <tr align='center' style ='font-weight: bold' scope='row'>
           ...
           <!--   <td style="border: black;font-size: 16px;height: 25px; width: 20px;"><?php //echo $value['cantidad_aprendices'];?></td> -->
               ...
               foreach ($conectarBD->query($sqlA) as $aprendiz) {
                ...
                ?></td>
             <td style="border: black;font-size: 16px;height: 25px; width: 20px;"><?php echo $value['inicio_formacion'];?></td>
             <td style="border: black;font-size: 16px;height: 25px; width: 20px;"><?php echo $value['fin_formacion'];?></td>
