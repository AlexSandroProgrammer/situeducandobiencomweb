...
<form role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
  ...
  <div class="form-row">
    <div class="form-group col-md-4"> 
      ...
      <input type="number" class="form-control " value="<?php if(isset($documento)){ echo $documento;} ?>" name="documento" maxlength="10"  required id="documento" class="">
    </div>
    ...
    <div class="form-group col-md-4">      
     ...
     <input type="text"  class="form-control" value="<?php if(isset($nombres)){ echo $nombres;} ?>" name="nombres" required id="nombres">
    </div>
</div>
<div class="form-row">
    <div class="form-group col-md-4">
      <label class="font-weight-bold">Apellidos:</label>
      <input type="text" class="form-control" name="apellidos"  value="<?php if(isset($apellidos)){ echo $apellidos;} ?>" required id="apellidos">
    </div>
        
           
              <div class="form-group col-md-4">           
            <label class="font-weight-bold">Telefono:</label>
            <input type="number" class="form-control " name="telefono"  value="<?php if(isset($telefono)){ echo $telefono;} ?>"  required="" id="telefono" class="campos">
            </div>
            <div class="form-group col-md-4"> 
...
?>
  ...
  <div class="form-row">         
    ...
    <div class="form-group col-md-4">               
       ...
       <input type="email" name="email"  value="<?php if(isset($email)){ echo $email;} ?>" id="correo" placeholder="@misena.edu.co" required class="form-control ">
    </div>
  </div>         
