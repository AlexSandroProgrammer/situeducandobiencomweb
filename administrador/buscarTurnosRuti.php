...
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col">        
                   <a class="btn btn-warning font-weight-bold text-light" href="listaTurnosRutinario.php">Todos los Turnos</a>
                </div>
...
if($conectarBD->query($sqlSE)->num_rows > 0){
  ...
  <i class='btn icon-checkmark1 text-success' style="font-size: 20px;" href ='#' onclick='confirmar1(<?php echo $ficha['codigoTurno'];?>)' onclick='this.disabled="disabled"'></i></td>
     <?php if ($idUser==1) { ?>
  <td>
  <?php
    switch ($ficha['estado']) {
...
?>
  ...
  <button class="dropdown-item" type="button">Nombre Unidad <?php echo $ficha['nombreUnidad'];?></button>
...
?>
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
  <button class="dropdown-item" type="button">Nombre Unidad <?php echo $fila['nombreUnidad'];?></button>
  <button class="dropdown-item" type="button">Hora Inicio Tarde <?php echo $horaInicioT;?></button>
  <button class="dropdown-item" type="button">Hora Fin Tarde <?php echo $horaFinT;?></button>
  </div>
</div>
...
if( $conectarBD->query($sqlS)->num_rows > 0){
  ...
  <tr align='center' class='font-weight-bold' scope='row'>
    ...
    <td  align='center' class='font-weight-bold'>   
  <i class='btn icon-checkmark1 text-success' style="font-size: 20px;" href ='#' onclick='confirmar1(<?php echo $turno['codigoTurno'];?>)' onclick='this.disabled="disabled"'></i></td>
            <?php if ($tipoUsuario == 'administrador' ) {
                        if ($idUser ==1) {
              ?>
            <td><?php 
...
?>
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
  <button class="dropdown-item" type="button">Nombre Unidad <?php echo $turno['nombreUnidad'];?></button>
  <button class="dropdown-item" type="button">Hora Inicio Tarde <?php echo $horaInicioT;?></button>
  <button class="dropdown-item" type="button">Hora Fin Tarde <?php echo $horaFinT;?></button>
  </div>
</div>
...
swalWithBootstrapButtons.fire({
  ...
  if (result.value) {
    window.location.href="pdfTurnoR.php?E=1&<?php if(isset($_REQUEST['busqueda'])){?>busqueda=<?php  echo $_REQUEST['busqueda'];} if(isset($_REQUEST['id_ficha'])){?>id_ficha=<?php echo $_REQUEST['id_ficha'];} if(isset($_REQUEST['fechaTurno'])){?>fechaTurno=<?php echo $_REQUEST['fechaTurno'];} ?>";
}else if (
...
swalWithBootstrapButtons.fire({
  ...
  if (result.value) {
    window.location.href="descargarPDFTR.php?<?php  if(isset($_REQUEST['busqueda'])){?>busqueda=<?php  echo $_REQUEST['busqueda'];} if(isset($_REQUEST['id_ficha'])){?>id_ficha=<?php echo $id_ficha;} if(isset($_REQUEST['fechaTurno'])){?>fechaTurno=<?php echo $_REQUEST['fechaTurno'];} ?>"; 
}else if (
